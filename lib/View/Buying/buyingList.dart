...
import 'package:study/repository/myPage/buyingList_repository.dart';
...
class _BuyingListState extends State<BuyingList> {
  ...
  Posts posts = Get.find<Posts>();
    ...
    BuyingListRepository buyingListRepository = BuyingListRepository();
    ...
    await buyingListRepository.buyingListMethod(); // 구매내역 로드 함수
    print('구매내역 불러오기');
    if (mounted) {
      // ui 업데이트
      setState(() {});
        ...
        child: Column(
            ...
            child: RefreshIndicator(
              ...
              child: ListView.builder(
                itemCount: posts.buyingListPosts.length,
                        ...
                        child: InkWell(
                          onTap: () {
                            Map<String, dynamic> arguments = {
                              'post': posts.buyingListPosts[index],
                              'index': index,
                              };
                                ...
                                Container(
                                  ...
                                  child: AspectRatio(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                          'http://10.0.2.2:8000/getImage?imagePath=${posts.buyingListPosts[index]['images'][0]}',
                                          width: 40,
                                          height: 40,
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text(
                                            posts.buyingListPosts[index]['title'], //posts의 title
                                            style: TextStyle(
                                                fontSize: 20,
                                        ...
                                        Container(
                                          width: screenWidth * 0.5,
                                          child: Text(
                                            '구매 일자 : ${formatDate(posts.buyingListPosts[index]['expiryTime'])}', //posts의 expiryTime
                                            style: TextStyle(
                                                fontSize: 12.5,
                                        ...
                                        Container(
                                          width: screenWidth * 0.5,
                                          child: Text(
                                            '최종 거래가 : ${currencyFormat.format(posts.buyingListPosts[index]['price'])}',
