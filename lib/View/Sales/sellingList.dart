...
import 'package:study/repository/myPage/sellingList_repository.dart';
...
class _SellingListState extends State<SellingList> {
  ...
  SellingListRepository sellingList = SellingListRepository();
  ...
  Future<void> loadData() async {
    ...
    await sellingList.sellingListMethod();
            ...
            children: [
              ...
              child: RefreshIndicator(
                ...
                child: ListView.builder(
                  itemCount: posts.sellingListPosts.length,
                          ...
                          child: InkWell(
                            onTap: () {
                              Map<String, dynamic> arguments = {
                                'post': posts.sellingListPosts[index],
                                'index': index,
                              };
                                  ...
                                  Container(
                                    ...
                                    child: AspectRatio(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                            'http://10.0.2.2:8000/getImage?imagePath=${posts.sellingListPosts[index]['images'][0]}',
                                            width: 40,
                                            height: 40,
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Container(
                                            width: screenWidth * 0.5,
                                            child: Text(
                                              '즉시 구매가 : ${currencyFormat.format(posts.sellingListPosts[index]['price'])}',
                                          ...
                                          Container(
                                            width: screenWidth * 0.5,
                                            child: Text(
                                              '현재 입찰가 : ${currencyFormat.format(posts.sellingListPosts[index]['bid'])}',
                                              style: TextStyle(fontSize: 15),
                                              textAlign: TextAlign.right,
                                            ),
                                          ),
